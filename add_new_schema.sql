-- =====================================================
-- NOUVELLES TABLES POUR NOTIFICATIONS ET CHAT
-- À exécuter sur Supabase après schema.sql
-- =====================================================

-- =====================
-- TABLE USER_DEVICES (pour FCM push)
-- =====================
...
-- =====================
-- INSERT PRESETS DE BASE
-- =====================
INSERT INTO notification_presets (name, title, message, type, created_by) VALUES
('Nouveau message', 'Nouveau message', 'Vous avez reçu un nouveau message dans votre commande', 'info', 1),
('Commande confirmée', 'Commande confirmée', 'Votre commande a été confirmée par le vendeur', 'info', 1),
('Commande annulée', 'Commande annulée', 'Votre commande a été annulée', 'warning', 1);
